...
function requre(module) {
    return __webpack_require__(8)(module + ".js");
}
...
module.exports = {
    InvalidRequestProvider: function InvalidRequestProvider() {
...
var errors = __webpack_require__(5);
var JsonRpc = __webpack_require__(7);
...
JsonRpc.isValidResponse = function (response) {
    ...
    function validateSingleMessage(message) {
        return !!message && !message.error && message.jsonrpc === JsonRpc.jsonRpcVersion && typeof message.id === 'number' && message.result !== undefined; // only undefined is not valid json object
    }
};
...
var map = {
	...
	"./xcube/api/xb.js": 2,
	"./xcube/errors.js": 5,
	"./xcube/request/jsonRpc.js": 7,
	"./xcube/request/requestManager.js": 6
};

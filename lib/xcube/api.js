...
API.prototype.setRequestManager = function (rm) {
    console.log("setRequestManager() rm=", rm);
    this.requestManager = rm;
};

API.prototype.attachToObject = function (obj) {
    console.log("attachToObject() obj=", obj);
    viewObj("attach obj", obj);
...
API.prototype.buildCall = function () {
    console.log("buildCall()");
    var api = this;
    var send = function () {
        console.log("send inner func");
...
API.prototype.toPayload = function (args) {
    ...
    console.log("toPayload() call=", call, " callback=", callback, " params=", params);

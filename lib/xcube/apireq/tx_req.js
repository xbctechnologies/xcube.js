...
var TxRequest = function (pType, actionType) {
    ...
    switch (actionType) {
        ...
        case "obj":
            ...
            var sender = "0x96a76d177a4b361d2ebec4ca3dfdf8fd330a80c5";
            var receiver = "0xd09913fec8f4797b5344eddea930d2558e5d9015";
            var validator = "0xa642f33ec1a951eceded3cf9e51edea1a806105b";
            ...
            this.fee = fee;
            this.amount = amount;
            // this.time = TimeUtil.getMicroseconds();
        ...
        default:
            ...
            this.time = "Microseconds value used in transaction signature";
            this.r = "R value obtained from transaction signature";
            this.s = "S value obtained from transaction signature";
            this.v = "V value obtained from transaction signature";

            this.payloadType = "Set payloadType (1~10)";
            this.payloadBody = showDescription(pType);
            break;
    }
};
...
var showDescription = function (type) {
    ...
    switch (type) {
        ...
        case 7: // GRProposalType
            ...
            res = {
                rewardXtoPerCoin: "Reward amount per coin",
...
var showSample = function (type) {
    ...
    switch (type) {
        ...
        case 7: // GRProposalType
            ...
            res = {
                rewardXtoPerCoin: '1000000000', //1GXTO

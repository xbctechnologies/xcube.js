...
var TxRequest = function (pType, wannaSample) {
    ...
    if (wannaSample === false) { // description
        ...
        var sender = "eba3f7d6983141ecbca0319aed800458d9a3f2d5";
        var receiver = "392531466fe4f4a4368fb48c33bf13dec2b518a9";
        var amount = '10';
        ...
        if (pType === 3) { // bonding
            ...
            fee = '10000000000000000000'; // 10, 000,000,000,000,000,000
        } else if (pType === 8) {
            fee = '0';
        } else if (pType === 10){
    ...
    switch (type) {
        ...
        case 2: // FileType
            ...
            res = {
                ...
                authors: [
                    "d0e78ef69ec9dd628bc90b323887999e5d75cd20",
                    "905a76202edfb2530344ee7cb1f531d96d7da707"
                ]
            };
            break;
        case 3: // BondingType
        ...
        case 5: // DelegatingType
            res = {
                validatorAccountAddr: "9de91697e8fa30a7424e229121782fc8cc62aba0", //"9DE91697E8FA30A7424E229121782FC8CC62ABA0",
        ...
        case 6: // UndelegatingType
            ...
            break;
        case 7: // GRProposalType
            var cr = new CurrentReflection('1728000', '864000');
            res = {
                rewardAmount:       '1000', //1000ATX
                validatorRewardRate:'9223372036',
        ...
        case 10: // MakeXChainType
            ...
            var a1 = new AssetHolder("d0e78ef69ec9dd628bc90b323887999e5d75cd20", '100');
            var a2 = new AssetHolder("905a76202edfb2530344ee7cb1f531d96d7da707", '200');

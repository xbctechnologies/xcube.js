...
var info = function () {
    ...
    console.log("- ex.tx(1, true)   = Show CommonTx sample data.");
    console.log("- ex.tx(2)         = Show FileTx example.");
    console.log("- ex.tx(2, true)   = Show FileTx sample data.");
    console.log("- ex.tx(3)         = Show BondingTx example.");
    console.log("- ex.tx(3, true)   = Show BondingTx sample data.");
    console.log("- ex.tx(4)         = Show UnbondingTx example.");
    console.log("- ex.tx(4, true)   = Show UnbondingTx sample data.");
    console.log("- ex.tx(5)         = Show DelegatingTx example.");
    console.log("- ex.tx(5, true)   = Show DelegatingTx sample data.");
    console.log("- ex.tx(6)         = Show UndelegatingTx example.");
    console.log("- ex.tx(6, true)   = Show UndelegatingTx sample data.");
    console.log("- ex.tx(7)         = Show GRProposalTx example.");
    console.log("- ex.tx(7, true)   = Show GRProposalTx sample data.");
    console.log("- ex.tx(8)         = Show GRVoteTxTxe example.");
    console.log("- ex.tx(8, true)   = Show GRVoteTxTxe sample data.");
    console.log("- ex.tx(9)         = Show RecoverValidatorTx example.");
    console.log("- ex.tx(9, true)   = Show RecoverValidatorTx sample data.");
    console.log("- ex.tx(10)        = Show MakeXChainTx example.");
    console.log("- ex.tx(10, true)  = Show MakeXChainTx sample data.");
    return null;
};
